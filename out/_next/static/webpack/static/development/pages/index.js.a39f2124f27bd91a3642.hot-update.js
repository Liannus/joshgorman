...
function (_React$Component) {
  ...
  function Experience(props) {
    ...
    _this.cards = [{
      ...
      content: "Followed Agile methodologies, taking part in sprint planning, daily standups and retrospectives." + "Developed Mock-ups in Figma and agile artifacts to properly estimate the development processes goals." + "Developed front-end views, backend connections and database integrations to control application flow." + "Collaborated with group members to maintain quality code with, linting, testing and code reviews.",
...
//# sourceMappingURL=index.js.a39f2124f27bd91a3642.hot-update.js.map